...
import { faPhp, faHtml5, faJs, faCss3Alt, faLinux } from "@fortawesome/free-brands-svg-icons";
    ...
    <React.Fragment>
      <section className="container about" id="about">
            <div className="main-title">
                <h1>ABOUT <span>ME</span><br></br></h1>
            </div>
            <div id="skills-title"><h2>Some of my skills</h2></div>
            <div className="skills-container">
              ...
              <div className="skill-box">
                <div className="skill-title">
                  <FontAwesomeIcon icon={faPhp} size='4x'></FontAwesomeIcon>
                  <h3>PHP</h3>
                </div>
                <p>Lorem ipsum dolor sit.</p>
              </div>
              <div className="skill-box">
                <div className="skill-title">
                  <FontAwesomeIcon icon={faLinux} size='4x'></FontAwesomeIcon>
                  <h3>Linux</h3>
                </div>
                <p>Lorem ipsum dolor sit.</p>
              </div>
